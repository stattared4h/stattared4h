...
- Djursidan visar ID:t med etiketten **Öronmärke**. Djurinfosidan låter besökaren söka på hela ID:t och går direkt till rätt djur. <!-- 02-§5.36 -->
- Sökningen använder exakt normaliserad träff. Suffix-sökning används inte, eftersom en kort ändelse kan passa flera djur och då ge sken av en unik träff. <!-- 02-§5.37 -->
