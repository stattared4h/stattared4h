...
| `02-§10.44` | Fällan är `<details>` och kräver ingen JavaScript | `byggd` | `<details class="site-menu__details">` i `source/layouts/header.njk`; `tests/build/site.test.ts` kräver elementet och att `source/ts/ui/menu.ts` inte nämner `details` eller `summary` |
