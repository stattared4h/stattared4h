...
| `02-§5.44` | Alla platsnamn syns inzoomad | `manuell` | `.map--zoomed` upphäver döljandet i `layout.css`. Bygg med `DATA_DIR=source/data-qa`, öppna `/` i 360 px och zooma in mot gårdsplanen: varje plats i klungan ska synas med namn, också de vars etikett är dold i överblick (`02-§5.33`) |
